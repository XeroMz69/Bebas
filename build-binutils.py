...
def invoke_configure(binutils_folder, build_folder, install_folder, target,
    ...
    if host_arch:
        configure += [
            f'CFLAGS=-O3 -pipe -fstack-protector-strong -fuse-linker-plugin -ffunction-sections -fdata-sections -march={host_arch} -mtune={host_arch}',
            f'CXXFLAGS=-O3 -pipe -fstack-protector-strong -fuse-linker-plugin -ffunction-sections -fdata-sections -march={host_arch} -mtune={host_arch}'
        ]
    else:
        configure += [
            'CFLAGS=-O3 -pipe -fstack-protector-strong -fuse-linker-plugin -ffunction-sections -fdata-sections', 
            'CXXFLAGS=-O3 -pipe -fstack-protector-strong -fuse-linker-plugin -ffunction-sections -fdata-sections',
            'LDFLAGS=-O3'
        ]
